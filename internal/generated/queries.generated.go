...
func (ec *executionContext) field_Mutation_createTodo_argsInput(
	...
	if tmp, ok := rawArgs["input"]; ok {
		return ec.unmarshalNNewTodo2githubᚗcomᚋTakakiAraki09ᚋk8sᚑlessonᚋinternalᚋmodelᚐNewTodo(ctx, tmp)
	}
...
func (ec *executionContext) _Mutation_createTodo(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNTodo2ᚖgithubᚗcomᚋTakakiAraki09ᚋk8sᚑlessonᚋinternalᚋmodelᚐTodo(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalNNewTodo2githubᚗcomᚋTakakiAraki09ᚋk8sᚑlessonᚋinternalᚋmodelᚐNewTodo(ctx context.Context, v any) (model.NewTodo, error) {
