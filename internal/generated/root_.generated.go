...
var sources = []*ast.Source{
	{Name: "../../schema/graph/queries.graphqls", Input: `# GraphQL schema example
#
...
extend type Mutation {
  createTodo(input: NewTodo!): Todo!
	...
	{Name: "../../schema/graph/todo.graphqls", Input: `type Todo {
  id: ID!
  text: String!
  done: Boolean!
  userId: ID!
  user: User!
	...
	{Name: "../../schema/graph/user.graphqls", Input: `type User {
  id: ID!
  name: String!
  todos: [Todo!]!
}
